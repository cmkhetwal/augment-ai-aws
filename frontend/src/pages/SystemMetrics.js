...
const MetricCard = React.memo(({ instanceId, metrics, instanceName }) => {
  return (
...
const SystemMetrics = ({ data }) => {
  ...
  // Memoize the metric cards to prevent unnecessary re-renders
  const metricCards = useMemo(() => {
    return Object.entries(systemMetrics).map(([instanceId, metrics]) => {
